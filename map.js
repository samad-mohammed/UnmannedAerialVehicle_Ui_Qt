...
var map = po.map()
    ...
    .center({lat:17.4401, lon:78.3489})
.zoom(14)
    .add(po.interact())
    .add(po.hash());

// Define the new center coordinates
//var newCenter = [17.4401, 78.3489]; // Replace with your desired coordinates

// Set the new center coordinates
//map.center(newCenter);

// Optionally, you can also set the zoom level if needed
//map.zoom(12); // Replace 12 with your desired zoom level

//    map = map.center([17.3850, 78.4867])
//              .zoom(12)
